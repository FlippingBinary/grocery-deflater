...
> {
  ...
  declare removeLocations: HasManyRemoveAssociationsMixin<LocationModel, number>
...
> {
  ...
  declare addHistories: HasManyAddAssociationsMixin<VariantHistoryModel, number>
  declare setHistories: HasManySetAssociationsMixin<VariantHistoryModel, number>
  ...
  declare hasHistories: HasManyHasAssociationsMixin<VariantHistoryModel, number>
...
> {
  ...
  declare addProductLists: HasManyAddAssociationsMixin<ProductListModel, number>
  declare setProductLists: HasManySetAssociationsMixin<ProductListModel, number>
  ...
  declare hasProductLists: HasManyHasAssociationsMixin<ProductListModel, number>
